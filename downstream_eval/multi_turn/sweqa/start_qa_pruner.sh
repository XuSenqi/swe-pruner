...
export ANSWER_OUTPUT_PATH=./answer-pruner
export TRAJ_OUTPUT_PATH=./traj-pruner
export EXPERIMENT_TYPE=pruner                 # baseline 或 pruner
...
nohup uv run python openhands-qa/main.py >> qa_pruner.log &
